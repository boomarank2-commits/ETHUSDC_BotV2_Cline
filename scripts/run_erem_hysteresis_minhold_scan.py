"""Run the EREM hysteresis/min-hold training-only scan."""
...
from src.research.erem_hysteresis_minhold_scan import (  # noqa: E402
...
def main() -> None:
    report = run_erem_hysteresis_minhold_scan(
        EremHysteresisConfig(
            output_dir=Path("reports/research/erem_hysteresis_minhold_scan")
        )
    )
    print(
        json.dumps(
